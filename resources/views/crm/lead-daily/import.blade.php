    ...
    <div class="bg-white border-2 border-black p-4 mb-6">
        <div class="text-sm font-['Times_New_Roman'] mb-4 leading-relaxed">
            ...
            <p class="mt-2 text-xs text-gray-600">
                Kolom wajib: <strong>Tanggal</strong>, <strong>Event ID</strong>, dan <strong>Leads</strong>.
                Baris dengan data tidak valid akan dilewati.
            </p>
        </div>

        <div class="flex items-center gap-3 mb-6">
            <a href="{{ route('lead-daily.export-template') }}"
        ...
        <form method="POST" action="{{ route('lead-daily.import-store') }}" enctype="multipart/form-data">
            @csrf

            <label class="block text-sm font-[Helvetica] font-bold mb-2">Pilih File XLSX:</label>
            <input type="file" name="file" accept=".xlsx"
                   class="block w-full border-2 border-black px-3 py-2 text-sm font-['Times_New_Roman'] bg-white rounded-none file:border-0 file:bg-[#c0392b] file:text-white file:px-3 file:py-1 file:mr-3 file:font-[Helvetica] file:font-bold file:cursor-pointer">
            ...
            <div class="flex items-center gap-2 mt-4">
                ...
                <button type="submit"
                        class="bg-[#c0392b] text-white px-4 py-1.5 text-sm font-[Helvetica] font-bold border-2 border-black rounded-none hover:bg-[#a93226]">
                    ↑ Import
                </button>
            </div>
        </form>
