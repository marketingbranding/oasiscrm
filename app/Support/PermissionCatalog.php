...
class PermissionCatalog
{
    ...
    public static function permissions(): array
    {
        $permissions = [
            ...
            ['name' => 'Menganonimkan pengguna', 'slug' => 'users.anonymize', 'description' => 'Menganonimkan akun pengguna dengan melepas data pribadi.', 'group_name' => 'Pengguna'],
            ['name' => 'Melepas email pengguna', 'slug' => 'users.release_email', 'description' => 'Melepas alamat email akun pengguna agar dapat dipakai ulang.', 'group_name' => 'Pengguna'],
    ...
    public static function rolePermissions(): array
    {
        ...
        return [
            ...
            'supervisor' => [
                ...$scoped(['sales_pocketbook'], ['team', 'assigned'], ['view', 'export']),
            ...
            'branch_manager' => [
                ...
                'consumer_progress.view', 'consumer_progress.sync', 'consumer_progress.reveal_nik', 'bridge_fund.view', 'bridge_fund.manage', 'bridge_fund.export',
                'expenses.view', 'expenses.create', 'expenses.update', 'expenses.cancel', 'expenses.export',
