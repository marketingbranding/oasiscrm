...
@section('content')
    <div class="bg-[#f1c40f] border-2 border-black px-4 py-2 mb-6">
        <h1 class="font-['Arial_Black'] font-black text-xl uppercase">Edit Dana Talangan</h1>
    </div>
            ...
            <form method="POST" action="{{ route('dana-talangan.update', ['dana_talangan' => $record->id]) }}" class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" name="tanggal" value="{{ old('tanggal', $record->tanggal->format('Y-m-d')) }}" required
                               class="w-full border-2 border-black px-3 py-2 text-sm font-['Times_New_Roman'] bg-white rounded-none @error('tanggal') border-[#e91d2a] @enderror">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="text" name="kav" value="{{ old('kav', $record->kav) }}"
                ...
                <div>
                    ...
                    <textarea name="penyelesaian" rows="3" class="w-full border-2 border-black px-3 py-2 text-sm font-['Times_New_Roman'] bg-white rounded-none @error('penyelesaian') border-[#e91d2a] @enderror">{{ old('penyelesaian', $record->penyelesaian) }}</textarea>
