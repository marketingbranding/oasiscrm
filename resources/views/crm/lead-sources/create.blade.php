...
@section('title', 'Tambah Sumber Lead - Oasis CRM')

@section('content')
    <div class="bg-[#5d8e8e] border-2 border-black px-4 py-2 mb-6">
        <h1 class="font-['Arial_Black'] font-black text-xl uppercase">Tambah Sumber Lead</h1>
    </div>

    <div class="border-2 border-black bg-white">
        <div class="bg-black text-white px-4 py-2 font-[Helvetica] font-bold text-xs uppercase">
            Form Sumber Lead Baru
        </div>
        <div class="p-4 sm:p-6">
            <form method="POST" action="{{ route('lead-sources.store') }}" class="space-y-4">
                @csrf
