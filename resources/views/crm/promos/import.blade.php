...
<form method="POST" action="{{ route('promos.import.preview') }}" class="grid max-w-4xl gap-4 border-2 border-black bg-white p-4">@csrf
    ...
    <p class="text-sm">Urutan kolom: id_promo, nama_promo, tanggal_mulai, tanggal_selesai, keterangan. Tanggal dari Google Sheets akan dibaca dalam format M/D/YYYY atau YYYY-MM-DD.</p>
