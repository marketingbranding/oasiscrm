...
Recommended direction, not implemented: migrate remaining Google mirror/snapshot modules to normalized local data with explicit import/sync boundaries. Detailed audit and additive Phase 1 specification: `docs/DATABASE_LOCAL_MIGRATION_PLAN.md` (**PLANNED / NOT IMPLEMENTED**).
