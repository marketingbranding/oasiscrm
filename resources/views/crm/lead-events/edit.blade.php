                        ...
                        <div class="select-dropdown hidden absolute top-full left-0 right-0 z-50 border-2 border-black bg-white">
                            ...
                            <ul class="select-options list-none m-0 p-0 max-h-48 overflow-y-auto">
                                @foreach($branches as $b)
                                    <li data-value="{{ $b->id }}" class="px-3 py-1.5 text-sm font-['Times_New_Roman'] cursor-pointer hover:bg-[#e6915d] hover:text-white {{ old('branch_id', $event->branch_id) == $b->id ? 'bg-[#e6915d] text-white' : '' }}">{{ $b->name }}</li>
                                @endforeach
                            </ul>
                        </div>
                        ...
                        <div class="select-dropdown hidden absolute top-full left-0 right-0 z-50 border-2 border-black bg-white">
                            ...
                            <ul class="select-options list-none m-0 p-0 max-h-48 overflow-y-auto">
                                @foreach($projects as $p)
                                    <li data-value="{{ $p->project_name }}" data-branch="{{ $p->branch_id }}" class="px-3 py-1.5 text-sm font-['Times_New_Roman'] cursor-pointer hover:bg-[#e6915d] hover:text-white {{ old('project_name', $event->project_name) === $p->project_name ? 'bg-[#e6915d] text-white' : '' }}">{{ $p->project_name }}</li>
                                @endforeach
                            </ul>
                        </div>
                        ...
                        <div class="select-dropdown hidden absolute top-full left-0 right-0 z-50 border-2 border-black bg-white">
                            ...
                            <ul class="select-options list-none m-0 p-0 max-h-48 overflow-y-auto">
                                @foreach($sources as $src)
                                    <li data-value="{{ $src }}" class="px-3 py-1.5 text-sm font-['Times_New_Roman'] cursor-pointer hover:bg-[#e6915d] hover:text-white {{ old('lead_source', $event->lead_source) === $src ? 'bg-[#e6915d] text-white' : '' }}">{{ $src }}</li>
                                @endforeach
                            </ul>
                        </div>
