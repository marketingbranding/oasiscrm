...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('dana_talangan_bridge_settings')) {
        ...
        if (! Schema::hasColumn('dana_talangans', 'project_id')) {
        ...
        if (! Schema::hasTable('dana_talangan_reconciliation_items')) {
            Schema::create('dana_talangan_reconciliation_items', function (Blueprint $table): void {
                ...
                $table->index(['spreadsheet_id', 'remote_row_number'], 'dana_recon_sheet_row_idx');
            });
        }
    }
